...
| Type | Name |
| ---: | :--- |
|   | [**DataLinkTx**](classjac_1_1DataLinkTx.md#function-datalinktx-13) () = default<br> |
|   | [**DataLinkTx**](classjac_1_1DataLinkTx.md#function-datalinktx-23) (const [**DataLinkTx**](classjac_1_1DataLinkTx.md) &) = delete<br> |
|   | [**DataLinkTx**](classjac_1_1DataLinkTx.md#function-datalinktx-33) ([**DataLinkTx**](classjac_1_1DataLinkTx.md) &&) = delete<br> |
| virtual std::unique\_ptr&lt; [**Packet**](classjac_1_1Packet.md) &gt; | [**buildPacket**](classjac_1_1DataLinkTx.md#function-buildpacket) (uint8\_t channel) = 0<br>_Build a packet for the given channel._  |
| virtual size\_t | [**maxPacketSize**](classjac_1_1DataLinkTx.md#function-maxpacketsize) () const = 0<br>_Get the maximum packet size for the given channel._  |
|  [**DataLinkTx**](classjac_1_1DataLinkTx.md) & | [**operator=**](classjac_1_1DataLinkTx.md#function-operator) (const [**DataLinkTx**](classjac_1_1DataLinkTx.md) &) = delete<br> |
|  [**DataLinkTx**](classjac_1_1DataLinkTx.md) & | [**operator=**](classjac_1_1DataLinkTx.md#function-operator_1) ([**DataLinkTx**](classjac_1_1DataLinkTx.md) &&) = delete<br> |
