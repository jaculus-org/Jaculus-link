...
| Type | Name |
| ---: | :--- |
|   | [**OutputPacketCommunicator**](classjac_1_1OutputPacketCommunicator.md#function-outputpacketcommunicator-12) () = default<br> |
|   | [**OutputPacketCommunicator**](classjac_1_1OutputPacketCommunicator.md#function-outputpacketcommunicator-22) (const [**OutputPacketCommunicator**](classjac_1_1OutputPacketCommunicator.md) &) = delete<br> |
| virtual std::unique\_ptr&lt; [**Packet**](classjac_1_1Packet.md) &gt; | [**buildPacket**](classjac_1_1OutputPacketCommunicator.md#function-buildpacket) (std::vector&lt; int &gt; links) = 0<br>_Build a packet for the given data links._  |
| virtual size\_t | [**maxPacketSize**](classjac_1_1OutputPacketCommunicator.md#function-maxpacketsize) (std::vector&lt; int &gt; links) const = 0<br>_Get the maximum packet size for the given data links._  |
|  [**OutputPacketCommunicator**](classjac_1_1OutputPacketCommunicator.md) & | [**operator=**](classjac_1_1OutputPacketCommunicator.md#function-operator) (const [**OutputPacketCommunicator**](classjac_1_1OutputPacketCommunicator.md) &) = delete<br> |
| virtual  | [**~OutputPacketCommunicator**](classjac_1_1OutputPacketCommunicator.md#function-outputpacketcommunicator) () = default<br> |
