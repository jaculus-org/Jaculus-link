...
| Type | Name |
| ---: | :--- |
|   | [**OutputStreamCommunicator**](classjac_1_1OutputStreamCommunicator.md#function-outputstreamcommunicator-12) () = default<br> |
|   | [**OutputStreamCommunicator**](classjac_1_1OutputStreamCommunicator.md#function-outputstreamcommunicator-22) (const [**OutputStreamCommunicator**](classjac_1_1OutputStreamCommunicator.md) &) = delete<br> |
|  [**OutputStreamCommunicator**](classjac_1_1OutputStreamCommunicator.md) & | [**operator=**](classjac_1_1OutputStreamCommunicator.md#function-operator) (const [**OutputStreamCommunicator**](classjac_1_1OutputStreamCommunicator.md) &) = delete<br> |
| virtual bool | [**put**](classjac_1_1OutputStreamCommunicator.md#function-put) (uint8\_t c) = 0<br>_Put a single byte to the stream._  |
| virtual void | [**setRecipients**](classjac_1_1OutputStreamCommunicator.md#function-setrecipients) (std::vector&lt; int &gt; recipients) = 0<br>_Set the data links the stream should be sent to. Empty links for broadcast._  |
| virtual size\_t | [**write**](classjac_1_1OutputStreamCommunicator.md#function-write) (std::span&lt; const uint8\_t &gt; data) = 0<br>_Write a buffer to the stream._  |
| virtual  | [**~OutputStreamCommunicator**](classjac_1_1OutputStreamCommunicator.md#function-outputstreamcommunicator) () = default<br> |
