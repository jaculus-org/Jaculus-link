...
| Type | Name |
| ---: | :--- |
| virtual int | [**get**](classjac_1_1InputStream.md#function-get) () = 0<br>_Get a single byte from the stream._  |
| virtual void | [**onData**](classjac_1_1InputStream.md#function-ondata) (std::function&lt; void(void)&gt;) = 0<br>_Register a callback to be called when data is available._  |
| virtual size\_t | [**read**](classjac_1_1InputStream.md#function-read) (std::span&lt; uint8\_t &gt; data) = 0<br>_Read data from the stream._  |
| virtual  | [**~InputStream**](classjac_1_1InputStream.md#function-inputstream) () = default<br> |
...
| Type | Name |
| ---: | :--- |
| virtual bool | [**flush**](classjac_1_1OutputStream.md#function-flush) () = 0<br> |
| virtual bool | [**put**](classjac_1_1OutputStream.md#function-put) (uint8\_t c) = 0<br>_Write a single byte to the stream._  |
| virtual size\_t | [**write**](classjac_1_1OutputStream.md#function-write) (std::span&lt; const uint8\_t &gt; data) = 0<br>_Write a buffer to the stream._  |
| virtual  | [**~OutputStream**](classjac_1_1OutputStream.md#function-outputstream) () = default<br> |
